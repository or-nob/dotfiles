...
command! -bang -nargs=? GFiles call fzf#vim#gitfiles('?', { 'down' : '60%', 'options': '--bind ctrl-a:select-all,ctrl-d:deselect-all,ctrl-n:preview-up,ctrl-m:preview-down' }, <bang>1)
